...
fatal: [PE1]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.1'
fatal: [P2]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.2'
fatal: [P7]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.7'
fatal: [P4]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.4'
fatal: [P3]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.3'
fatal: [P9]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.9'
fatal: [P8]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.8'
^C [ERROR]: User interrupted execution
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ sudo docker ps
CONTAINER ID   IMAGE                    COMMAND                  CREATED              STATUS              PORTS     NAMES
57340701b4f9   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-1
1cb1b42631ab   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-9
1a82d67ee6a6   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-5
882aab3550fd   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-4
c4e5eaa95aa1   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-6
63eb24762e65   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-8
04f806d04b4c   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-7
16aa4c31d784   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-3
92a6ec85af7c   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   About a minute ago   Up About a minute             xrd-2
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ sudo docker exec -it xrd-1 /pkg/bin/xr_cli.sh
...
RP/0/RP0/CPU0:xrd-1#sh run
Tue Mar  7 06:50:47.140 UTC
Building configuration...
!! IOS XR Configuration 7.7.1
!! Last configuration change at Tue Mar  7 06:50:03 2023 by root
!
hostname xrd-1
logging console debugging
logging monitor debugging
...
RP/0/RP0/CPU0:xrd-1#ping 192.168.18.1
Tue Mar  7 06:50:54.593 UTC
...
RP/0/RP0/CPU0:xrd-1#ping 192.168.18.2
Tue Mar  7 06:50:56.237 UTC
Type escape sequence to abort.
Sending 5, 100-byte ICMP Echos to 192.168.18.2, timeout is 2 seconds:
!!!!!
Success rate is 100 percent (5/5), round-trip min/avg/max = 1/5/16 ms
RP/0/RP0/CPU0:xrd-1#ping 192.168.18.100
Tue Mar  7 06:50:58.503 UTC
Type escape sequence to abort.
Sending 5, 100-byte ICMP Echos to 192.168.18.100, timeout is 2 seconds:
!!!!!
Success rate is 100 percent (5/5), round-trip min/avg/max = 1/2/4 ms
RP/0/RP0/CPU0:xrd-1#exit
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ cat /etc/hosts
127.0.0.1 localhost
...
192.168.18.1    pe1     PE1
192.168.18.2    p2      P2
192.168.18.3    p3      P3
192.168.18.4    p4      P4
192.168.18.5    pe5     PE5
192.168.18.6    p6      P6
192.168.18.7    p7      P7
192.168.18.8    p8      P8
192.168.18.9    p9      P9
...
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ ssh -l cisco pe1
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHA256:nuyU/5wlx+L5GkV8MF/iUn1RgiQHH+6txtcqmPs3JY4.
Please contact your system administrator.
Add correct host key in /home/lab/.ssh/known_hosts to get rid of this message.
Offending ECDSA key in /home/lab/.ssh/known_hosts:4
  remove with:
  ssh-keygen -f "/home/lab/.ssh/known_hosts" -R "pe1"
Host key for pe1 has changed and you have requested strict checking.
Host key verification failed.
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ cat ansible.cfg
[defaults]
host_key_checking = False
inventory = /home/lab/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing/inventory/hosts.ini
forks=30
...
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ vi ansible.cfg
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ ansible-playbook all_inclusive_play.yaml
...
ok: [PE5]
^C [ERROR]: User interrupted execution
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ cd ..
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr$ cd ..
(vxrdlab) lab@xrdlab:~/github$ sudo rm -r ansible-cisco-xrd-sr/
(vxrdlab) lab@xrdlab:~/github$ git clone https://github.com/hmntsharma/ansible-cisco-xrd-sr.git
Cloning into 'ansible-cisco-xrd-sr'...
remote: Enumerating objects: 139, done.
remote: Counting objects: 100% (139/139), done.
remote: Compressing objects: 100% (69/69), done.
remote: Total 139 (delta 75), reused 123 (delta 68), pack-reused 0
Receiving objects: 100% (139/139), 46.59 KiB | 2.03 MiB/s, done.
...
xrd-5 is up-to-date
xrd-3 is up-to-date
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr$ sudo docker-compose down
Stopping xrd-1 ... done
Stopping xrd-9 ... done
Stopping xrd-5 ... done
Stopping xrd-4 ... done
...
Removing xrd-3 ... done
Removing xrd-2 ... done
Removing network ansible-cisco-xrd-sr_mgmt
Removing network xrd-1-gi2-xrd-2-gi2
Removing network xrd-2-gi0-xrd-3-gi0
Removing network xrd-2-gi1-xrd-6-gi1
Removing network xrd-2-gi3-xrd-7-gi3
Removing network xrd-2-gi5-xrd-9-gi5
Removing network xrd-3-gi1-xrd-7-gi1
Removing network xrd-3-gi2-xrd-4-gi2
Removing network xrd-3-gi3-xrd-9-gi3
Removing network xrd-4-gi0-xrd-5-gi0
Removing network xrd-4-gi1-xrd-8-gi1
Removing network xrd-4-gi4-xrd-7-gi4
Removing network xrd-6-gi0-xrd-7-gi0
Removing network xrd-7-gi2-xrd-8-gi2
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr$ sudo docker container prune
WARNING! This will remove all stopped containers.
Are you sure you want to continue? [y/N] y
Total reclaimed space: 0B
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr$ sudo docker network pruine
...
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr$ sudo docker network prune
...
Creating network "xrd-4-gi0-xrd-5-gi0" with the default driver
Creating network "xrd-4-gi1-xrd-8-gi1" with the default driver
Creating network "xrd-4-gi4-xrd-7-gi4" with the default driver
Creating network "xrd-6-gi0-xrd-7-gi0" with the default driver
Creating network "xrd-7-gi2-xrd-8-gi2" with the default driver
Creating xrd-2 ... done
Creating xrd-7 ... done
...
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr$ sudo docker ps
CONTAINER ID   IMAGE                    COMMAND                  CREATED         STATUS         PORTS     NAMES
cadc7e7f23f0   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 3 seconds             xrd-3
7191e06e7a13   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 7 seconds             xrd-5
311f271216f9   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 4 seconds             xrd-9
ba3e55df37a5   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 4 seconds             xrd-6
18d126b44321   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 4 seconds             xrd-1
3224c2dfe927   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 3 seconds             xrd-4
a0b7064972f2   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 3 seconds             xrd-7
51da6bd30724   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 3 seconds             xrd-2
f874d463bd0b   localhost/ios-xr:7.7.1   "/bin/sh -c /sbin/xr…"   8 seconds ago   Up 5 seconds             xrd-8
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr$ cd ansible-cisco-segment-routing/
(vxrdlab) lab@xrdlab:~/github/ansible-cisco-xrd-sr/ansible-cisco-segment-routing$ ansible-playbook all_inclusive_play.yaml
...
fatal: [P9]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.9'
fatal: [P6]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.6'
fatal: [P8]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.8'
fatal: [PE5]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.5'
fatal: [P2]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.2'
fatal: [P4]: FAILED! => changed=false
  msg: '[Errno None] Unable to connect to port 22 on 192.168.18.4'
...
PLAY RECAP ***************************************************************************************************************************************************************************************************************
P2                         : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
P3                         : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
P4                         : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
P6                         : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
P7                         : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
P8                         : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
P9                         : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
PE1                        : ok=4    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
PE5                        : ok=3    changed=0    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
